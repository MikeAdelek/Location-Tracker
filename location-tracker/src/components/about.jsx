        ...
        <div className="row align-items-center">
          ...
          <div className="col-lg-6">
            ...
            <div className="about-content">
              <p>
                We are at the forefront of offering sophisticated real-life
                tracking with our location tracker. Focusing on quality and
                innovation, we provide technologies that provide real-time,
